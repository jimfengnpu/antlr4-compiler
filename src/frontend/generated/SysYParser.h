...
public:
  ...
  enum {
    ...
    RuleFuncType = 4, RuleBType = 5, RuleDef = 6, RuleFuncParam = 7, RuleBlock = 8, 
  ...
  public:
    SysYParser::FuncParamContext *funcParamContext = nullptr;
    std::vector<FuncParamContext *> params;
